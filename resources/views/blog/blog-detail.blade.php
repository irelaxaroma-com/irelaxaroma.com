...
@section('script')
    <script>
        ...
        function fetchBlogs() {
            $.ajax({
                type: 'get',
                url: "{{ env('url') }}" + '/api/client/blog_news?slug=' + slug + '&language_id=' + language_id +
        ...
        function fetchBlogCategories() {
            $.ajax({
                type: 'get',
                url: "{{ env('url') }}" + '/api/client/blog_category?getGallaryDetail=1&language_id=' +
        ...
        function fetchFeaturedBlogs(page) {
            var url = "{{ env('url') }}" + '/api/client/blog_news?limit=13&getGallaryDetail=1&getBlogCategory=1&is_featured=1&language_id='+language_id;
            $.ajax({
                type: 'get',
                url: url,
                headers: {
