...
<script>
    ...
    @if(isset($_GET["code"]) && $_GET["code"] != '')
        ...
        $.ajax({
            type: 'get',
            url: "{{ env('url') }}" + '/api/client/customer_login/'+sociallite+'/callback?code='+code+'&scope='+scope+'&authuser='+authuser+'&prompt='+prompt,
            headers: {
    ...
    function creatAcount() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ env('url') }}" + '/api/client/customer_register',
            data:{
    ...
    function loginAcount() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ env('url') }}" + '/api/client/customer_login',
            data:{
                email: email,
                password: password,
                session_id:cartSession,
