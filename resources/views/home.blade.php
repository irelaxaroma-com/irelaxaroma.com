...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            var url = "{{ env('url') }}" + '/api/client/products?limit=10&getDetail=1&language_id=' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        $('.banner-slider-link1').attr('href', "{{ env('url') }}" + data.data[0]
                            .banner_url);
                        $('.banner-slider-image1').attr('src', "/gallary/" + data.data[0].gallary.gallary_name);



                        $('.banner-slider-link2').attr('href', "{{ env('url') }}" + data.data[1]
                            .banner_url);
        ...
        function bannerMedia() {
            ...
            $.ajax({
                type: 'get',
                url: "{{ env('url') }}" + '/api/client/constant_banner?getLanguage=' + languageId + '&title=' +
                    bannerType +
